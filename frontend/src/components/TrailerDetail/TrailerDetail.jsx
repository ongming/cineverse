    ...
    const [reviews, setReviews] = useState([
        {
            ...
            rating: 5,
            content: "Kỳ xảo điện ảnh thực sự quá ấn tượng! Tôi chưa bao giờ thấy một bộ phim nào có bối cảnh chi tiết và mượt mà đến vậy. Diễn xuất của dàn diễn viên cũng rất xuất thần."
        },
        {
            id: 2,
            author: "Quốc Anh",
            ...
            rating: 5,
            content: "Cốt truyện lôi cuốn từ đầu đến cuối. Âm thanh trong rạp (hoặc hệ thống loa tốt) sẽ khiến bạn thực sự chìm đắm. Một bước tiến lớn cho thể loại này."
        }
    ]);
                ...
                <div className="detail-column">
                    ...
                    <div className="credits-grid">
                        ...
                        <div className="credit-item">
                            ...
                            <span className="credit-value rating-value">★ {movie.rating}</span>
                        </div>
                    </div>
                </div>
                    ...
                    {movie.cast.map((actor, index) => (
                        <div key={actor} className="actor-card">
                            <div className="actor-avatar">
                                ...
                                <img src={`https://i.pravatar.cc/150?img=${(index + 10) * 3}`} alt={actor} />
                            </div>
