    ...
    return (
        ...
        >
            <div className="relative w-full overflow-hidden rounded-lg">
                <img className="w-full aspect-[2/3] group-hover:scale-110 transition-transform duration-300 object-cover block" src={movie.poster_path} alt={movie.title} />
            ...
            <div className="p-3 flex flex-col gap-1.5">
                ...
                <span className="text-xs text-[#8c8c8c]">{new Date(movie.release_date).getFullYear()}</span>
            </div>
        </Link>
    );
}